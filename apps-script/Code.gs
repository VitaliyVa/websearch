 ...
 *      і у змінну APPS_SCRIPT_URL у налаштуваннях репозиторію GitHub
 *
 * ОНОВЛЕННЯ (усі наступні рази)
 *   1. Встав новий вміст, Ctrl+S
 *   2. Розгорнути → КЕРУВАТИ РОЗГОРТКАМИ → олівець біля наявного
 *   3. Версія → НОВА ВЕРСІЯ → Розгорнути
 *
 ...
 *
 *   «Новий розгорток» тут НЕ треба: він видасть іншу URL, і її довелося б
 *   міняти і в web/.env, і в змінній GitHub. Оновлення наявного зберігає URL.
 */
